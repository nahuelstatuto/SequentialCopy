...
def plot_results(data, sdt=None, plot_type='acc_test', path = 'plots', name=''):
    ...
    if plot_type == 'acc_test':
        ax.set_ylabel('Acc test', fontsize=16)
    elif plot_type == 'acc_train':
        ax.set_ylabel('Acc train', fontsize=16)
    elif plot_type == 'nN':
        ax.set_ylabel('Number of synthetic data points', fontsize=16)
    elif plot_type == 'rho':
        ax.set_ylabel(r'Average uncertainty $\rho$', fontsize=16)
    elif plot_type == 'lmda':
